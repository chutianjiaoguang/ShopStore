        ...
        if (row.F_ParentId == "0") {
            ...
            if (childNodes.length > 0) {
                ...
                $.each(childNodes, function (i) {
                    ...
                    _html += '<li>';
                    _html += '<a class="menuItem" data-id="' + subrow.F_Id + '" href="' + subrow.F_UrlAddress + '" data-index="' + subrow.F_SortCode + '">' + '<i class="' + subrow.F_Icon + '"></i><span>&nbsp&nbsp&nbsp' + subrow.F_FullName + '</span></a>';
                    _html += '</li>';
                });
                _html += '</ul>';
            }
